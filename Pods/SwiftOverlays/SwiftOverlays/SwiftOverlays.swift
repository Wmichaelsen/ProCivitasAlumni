...
@objc public extension UIViewController {
    ...
    */
    @discardableResult
    func showWaitOverlay(window: UIWindow? = nil) -> UIView {
        return SwiftOverlays.showCenteredWaitOverlay(self.view, window: window)
    }
    ...
    */
    func removeAllOverlays(window: UIWindow? = nil) {
        SwiftOverlays.removeAllOverlaysFromView(self.view, window: window)
    }
...
open class SwiftOverlays: NSObject {
    ...
    */
    ...
    // MARK: Non-blocking
    @discardableResult
    open class func showCenteredWaitOverlay(_ parentView: UIView, window: UIWindow? = nil) -> UIView {
        ...
        if window != nil {
            ...
            if #available(iOS 9.0, *) {
                ai.centerXAnchor.constraint(equalTo: window!.centerXAnchor).isActive = true
                ai.centerYAnchor.constraint(equalTo: window!.centerYAnchor).isActive = true
            } else {
    ...
    open class func removeAllOverlaysFromView(_ parentView: UIView, window: UIWindow? = nil) {
        if window != nil {
            window?.subviews
